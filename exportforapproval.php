...
$db = DB::getInstance();
    ...
    // $agentClass->select(" WHERE `payment_state`='Confirmed' OR `payment_state`='Free' AND `payment_state`!='Pending' AND `pass_type`!='No pass' AND `state`!='Confirmed' AND `category`!='Government' || (`state`!='Confirmed' AND `category`='Government' AND `payment_state`='Confirmed')");
    $agentClass->select(" WHERE (`payment_state`='Confirmed' AND `state`!='Confirmed' AND `payment_state`!='Pending') OR (`payment_state`='Free' AND `pass_type`!='No pass' AND `state`!='Confirmed' AND `category`!='Government') OR (`state`!='Confirmed' AND `category`='Government' AND `payment_state`='Confirmed')");
