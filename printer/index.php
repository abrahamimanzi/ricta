		...
		<script language="JavaScript"> 
			...
			var dnadmin = $("#gb_data").data('dnadmin');
				$("#webcam").scriptcam({
					...
					uploadImage: dnadmin+'/printer/upload.gif',
					...
					<div class="col-xs-4 colRight">
						<div style="">
							<div id="card_div" class="delegate">
								<header class="main" style="height: 110px; margin-top: 10px;">
									<img class="img img-responsive" style="width: 100%;" src="<?=DNADMIN?>/printer/assets/img/card_header.jpg">
								</header>
								<main class="body" style="width: 100%; height: 252px;">
									<div class="profile_div text-center" style="text-align: center">
										<img id="image" src="<?php if($data_exists && $agent_data->profile){ echo DNADMIN._.$agent_data->profile;}?>" class="profile" style="width:120px;height:120px; border: 2px solid #10B2E4;border-radius: 10px; margin-top: 30px;<?php if($data_exists){ echo $border_color;}?>"/>
									</div>
								...
								<footer style="height: 50px; width: 100%; display: block; color: #fff; font-size: 18px;">
