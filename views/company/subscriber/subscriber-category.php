                        ...
                        <table class="table no-margin">
                          ...
                          <tbody>
                            <?php
                              ...
                              $categTable = new ParticipantCategory();
                              $categTable->selectQuery("SELECT * FROM `events_participant_category` WHERE `interface`='group' OR `interface`='individual' AND `ID` !='1' AND `ID` !='2' AND `ID` !='3' AND `ID` !='4' ORDER BY `ID`");
