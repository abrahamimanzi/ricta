              ...
              <div>
                ...
                <div class="box">
                    ...
                    <?php
                        ...
                        // $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE  `payment_state`='Confirmed' OR `payment_state`='Free' AND `payment_state`!='Pending' AND `pass_type`!='No pass' AND `state`!='Confirmed' AND `category`!='Government' || (`state`!='Confirmed' AND `category`='Government' AND `payment_state`='Confirmed') $search_sql ");
                        $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`payment_state`='Confirmed' AND `state`!='Confirmed' AND `payment_state`!='Pending') OR (`payment_state`='Free' AND `pass_type`!='No pass' AND `state`!='Confirmed' AND `category`!='Government') OR (`state`!='Confirmed' AND `category`='Government' AND `payment_state`='Confirmed') $search_sql ");
                        $participantApprovalNumber = $participantTable ->count();
                    ?>
                      <h3 class="box-title">Pending status  <span style='color:#01aef0'><?=$participantApprovalNumber?></span></h3>
                        ...
                        <table class="table no-margin">
                          ...
                          <tbody>
                            ...
                            $seconds = \Config::get('time/seconds');
                              $participantTable = new Participant();
								// $participantTable->selectQuery("SELECT* FROM `events_participant` WHERE `payment_state`='Confirmed' OR `payment_state`='Free' AND `payment_state`!='Pending' AND `pass_type`!='No pass' AND `state`!='Confirmed' AND `category`!='Government' || (`state`!='Confirmed' AND `category`='Government' AND `payment_state`='Confirmed') AND `state`!=? AND `event_ID`=? $search_sql ORDER BY {$_SESSION['participant_sort']}",$sql_val_array);
                                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`payment_state`='Confirmed' AND `state`!='Confirmed' AND `payment_state`!='Pending') OR (`payment_state`='Free' AND `pass_type`!='No pass' AND `state`!='Confirmed' AND `category`!='Government') OR (`state`!='Confirmed' AND `category`='Government' AND `payment_state`='Confirmed') $search_sql ORDER BY {$_SESSION['participant_sort']}",$sql_val_array);
                            ...
                            if(Input::checkInput('keyword','get','0') || strlen(Input::get('keyword','get'))<3){
                                ...
                                // $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `payment_state`='Confirmed' OR `payment_state`='Free' AND `payment_state`!='Pending' AND `pass_type`!='No pass' AND `state`!='Confirmed' AND `category`!='Government' AND `state`!=? AND `event_ID`=? $search_sql ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}",$sql_val_array);
                                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`payment_state`='Confirmed' AND `state`!='Confirmed' AND `payment_state`!='Pending') OR (`payment_state`='Free' AND `pass_type`!='No pass' AND `state`!='Confirmed' AND `category`!='Government') OR (`state`!='Confirmed' AND `category`='Government' AND `payment_state`='Confirmed') $search_sql ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}",$sql_val_array);
								...
								if($participantTable->count()){
									...
									foreach($participantTable->data() as $participant_data){
                                        ...
                                        if(($participant_data->category == 'Silver'|| 
                                            $participant_data->category == 'Gold'|| 
                                            $participant_data->category == 'Platinum'|| 
                                            ...
                                            <div id="participant-menu-content-<?=$participant_data->ID?>" class="hidden">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'Admin-User' || $session_user_data->groups == 'Super-Admin-User' || $session_user_data->groups == 'OGS-User') && ($participant_data->category == 'Silver' ||$participant_data->category == 'Gold' ||$participant_data->category == 'Platinum' || $participant_data->category == 'Exhibitor')){?>
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <?php  
                            ...
                            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-list-exportforapproval" class="btn btn-sm btn-primary btn-flat pull-right">Export</a>
