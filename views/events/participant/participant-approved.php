              ...
              <div>
                ...
                <div class="box">
                    ...
                    <?php
                        ...
                        $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `state`='Confirmed' AND `pass_type`!='No pass' $search_sql ");
                        $participantApprovalNumber = $participantTable ->count();
                    ?>
                      <h3 class="box-title">Participant Approved <span style='color:#01aef0'><?=$participantApprovalNumber?></span></h3>
                        ...
                        <table class="table no-margin">
                          ...
                          <tbody>
                            ...
                            $seconds = \Config::get('time/seconds');
                              $participantTable = new Participant();
                                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `state`='Confirmed' AND `pass_type`!='No pass' $search_sql ");
                                // $participantTable->selectQuery("SELECT* FROM `events_participant` WHERE `state`!='Confirmed' AND `state`!=? AND `event_ID`=? $search_sql ORDER BY {$_SESSION['participant_sort']}",$sql_val_array);
                            ...
                            if(Input::checkInput('request','post',1)){
                              ...
                              $participantTable = new Participant();
                              // $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `state`!='Confirmed' AND `state`!=? AND `event_ID`=? $search_sql ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}",$sql_val_array);
                              $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `state`='Confirmed' AND `pass_type`!='No pass' ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}");
                                            ...
                                            <div id="participant-menu-content-<?=$participant_data->ID?>" class="hidden">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'Admin-User' || $session_user_data->groups == 'OGS-Admin' || $session_user_data->groups == 'Super-Admin-User') && ($participant_data->pass_type == 'Silver' ||$participant_data->pass_type == 'Gold' ||$participant_data->pass_type == 'Platinum' || $participant_data->pass_type == 'Exhibitor')){?>
                                                        ...
                                                        <?php }?>
                                                        <?php  
                                                        if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'Admin-User' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'Super-Admin-User'){?>
                                                        ...
                                                        <?php }?>
                                                        <?php  
                                                        if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'Admin-User' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'Super-Admin-User' || $session_user_data->groups == 'Sessions-Admin'){?>
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <?php  
                            if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'Super-Admin-User'){?>
                            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-list-exportapproved" class="btn btn-sm btn-primary btn-flat pull-right">Export</a>
                        <?php } ?>
                    </div>
                    <!-- /.box-footer -->
                </div>
