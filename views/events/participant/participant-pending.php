              ...
              <div>
                ...
                <div class="box">
                    ...
                    <?php
                        ...
                        $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `state`='Pending' AND `pass_type`!='No pass' $search_sql ");
                        $participantApprovalNumber = $participantTable ->count();
                    ?>
                      <h3 class="box-title">Pending Participant   <span style='color:#01aef0'><?=$participantApprovalNumber?></span></h3>
                        ...
                        <table class="table no-margin">
                          ...
                          <tbody>
                            ...
                            $seconds = \Config::get('time/seconds');
                              $participantTable = new Participant();
                                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `state`='Pending' AND `pass_type`!='No pass' ");
                            ...
                            if(Input::checkInput('request','post',1)){
                              ...
                              $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `state`='Pending' AND `pass_type`!='No pass' $search_sql ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}");
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <?php  
                            ...
                            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-list-exportpending" class="btn btn-sm btn-primary btn-flat pull-right">Export</a>
                        <?php } ?>
                    </div>
                    <!-- /.box-footer -->
                  </div>
