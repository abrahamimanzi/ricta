                ...
                <div class="box">
                    <div class="box-header with-border">
                        <?php
                            ...
                            $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Visitor' || `pass_type` = 'Silver' || `pass_type` = 'Gold' || `pass_type` = 'Platinum' || `pass_type` = 'Speakers' AND `state`!=? AND `event_ID`=? $search_sql ",$sql_val_array);
                            $participantApprovalNumber = $participantTable ->count();
                        ?>
                      <h3 class="box-title">Participants list<span style='color:#01aef0'><?=$participantApprovalNumber?></span></h3>
                        ...
                        <table class="table no-margin">
                          ...
                          <tbody>
                            ...
                            $seconds = \Config::get('time/seconds');
                              $participantTable = new Participant();
								$participantTable->selectQuery("SELECT* FROM `events_participant` WHERE `pass_type`='Visitor' || `pass_type` = 'Silver' || `pass_type` = 'Gold' || `pass_type` = 'Platinum' || `pass_type` = 'Speakers' AND `state`!=? AND `event_ID`=? $search_sql ORDER BY {$_SESSION['participant_sort']}",$sql_val_array);
                            ...
                            if(Input::checkInput('keyword','get','0') || strlen(Input::get('keyword','get'))<3){
                              ...
                              $participantTable = new Participant();
                              $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Visitor' || `pass_type` = 'Silver' || `pass_type` = 'Gold' || `pass_type` = 'Platinum' || `pass_type` = 'Speakers' AND `state`!=? AND `event_ID`=? $search_sql ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}",$sql_val_array);
								...
								if($participantTable->count()){
									...
									foreach($participantTable->data() as $participant_data){
                                        ...
                                        if(($participant_data->payment_state == 'Confirmed' || 
                                            ...
                                            $participant_data->pass_type == 'Speaker'|| 
                                            $participant_data->pass_type == 'Visitor') && $participant_data->state == 'Confirmed'){
                                            $stateColor = "#18ab86";                                    
                                            $lapsed_time = "--";
                                        }
                                        if(($participant_data->pass_type == 'Delegate'|| 
                                            ...
                                            <div id="participant-menu-content-<?=$participant_data->ID?>" class="hidden">
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'Admin-User' || $session_user_data->groups == 'Super-Admin-User' || $session_user_data->groups == 'OGS-User') && ($participant_data->pass_type == 'Silver' ||$participant_data->pass_type == 'Gold' ||$participant_data->pass_type == 'Platinum' || $participant_data->pass_type == 'Exhibitor')){?>
                                              ...
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                    ...
                                                    <?php if($participant_data->pass_type == "Media"){?>
                                                        <div class="participant_details">
                                                            <div class="participant_details-i" >
                                                    ...
                                                    <?php }?>
                                                    <?php if($participant_data->pass_type == "Delegate"){?>
                                                    <div class="participant_details">
                                                        <div class="participant_details-i" >
                                                  ...
                                                  <div class="modal-footer" style="text-align: left">
                                                    ...
                                                    <?php if($participant_data->pass_type == "Speaker" || $participant_data->pass_type == "Media"){
                    ...
                    <div class="box-footer clearfix">
                      <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-list" class="btn btn-sm btn-default btn-flat pull-right">View All Participants</a>
                        <?php  
                            ...
                            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-list-exportparticipants" class="btn btn-sm btn-primary btn-flat pull-right">Export</a>
                        <?php } ?>
                    </div>
                    <!-- /.box-footer -->
                  </div>
