...
class BasicParticipantController  
{
            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                try{
                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        $subject= 'Thank you for your application for '.EVENT.'';
                        ...
                        // $messageText_2= 'We will review your registration and get back to you within 7 working days.';
    ...
    public static function participantConfirmedEmail($participant_data){
        ...
        $messageText_1= 'Your registration for the '.EVENT.' (Kigali, Rwanda, 10 - 12 May 2017) has been confirmed.';
                ...
                <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                    ...
                    <section>
                        ...
                        <p style="font-size: 13px;">
                            ...
                            date with details on the dedicated '.EVENT.' bus network.  
                            You will be able to purchase pre-paid travel cards giving you access to 
                            the entire '.EVENT.' bus network during your stay in Kigali.
                        </p>
                        <p style="font-size: 13px;">
                            <b>Car hire:</b><br>
                            Should you wish to hire a car during your stay in Kigali, click here <a href="'.DN.'/plan">[Click here to plan your trip]</a>
                        </p>
                        '.@$messageText_3.'
                        './*
                        <p style="font-size: 13px;">
