            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                try{
                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        $messageText_2= 'As a government official, kindly note that your request will be processed by the relevant government authorities. They will communicate with you directly in due course. ';
