...
class TransportController  
{
	public static function add($form='Admin'){
        ...
        if($validation->passed()){
            ...
            $accommadationTable = new \Transport();
            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                try{
                    ...
                    */
                    ...
                    $accommadationTable->selectQuery("SELECT* FROM `transport` WHERE `email`=? ORDER BY `ID` DESC LIMIT 1",array($email));
                    ...
                    if($accommadationTable->count() && $accommadationTable->first()->email == $email){
                        ...
                        */
                        ...
                        $subject= 'Car reservation query for '.EVENT.'';

                        $messageText_0= 'Dear <b>'.$accommadation_data->firstname.' '.$accommadation_data->lastname.'</b>,';

                        $messageText_1= 'Thank you for submitting your car reservation query for the '.EVENT.' in Kigali, Rwanda.';

                        $messageText_2= 'Our team will revert to you shortly with availability and rates whilst also putting you in touch with the car reservation team directly.';

                        $messageText_3= 'Please note that all payments are to be made to the car directly.';
                        ...
                        $messageText_1= 'We have a new reservation application for the '.$accommadation_data->car.': Smartcities edition. Below are the applicants details.';
                        ...
                        $messageText_7= '<b>Hotel name:</b> '.$accommadation_data->car.'<br>
